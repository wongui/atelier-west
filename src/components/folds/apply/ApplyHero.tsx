 ...
 * FoldGrid content on top). Mobile is a genuinely different layout — the
 * photo fades into the solid background instead of sitting full-bleed
 * behind the text — so it's a full sibling component (ApplyHeroMobile),
 * not a breakpoint variant of this one; see ApplyHeroMobile.tsx.
 */
export function ApplyHero() {
  return (
    <div className="relative min-h-[90vh] overflow-hidden bg-surface-light">
      <img
        src={withBasePath("/images/apply-hero-bg.png")}
        alt=""
        className="absolute inset-0 h-full w-full object-cover"
      />
      <FoldGrid className="relative min-h-[90vh] items-center py-24">
